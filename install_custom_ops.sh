...
cd gaussianformer/encoder/gaussian_encoder/ops && pip install -e . && cd -
cd gaussianformer/head/localagg && pip install -e . && cd -
# for GaussianFormer-2
cd gaussianformer/head/localagg_prob && pip install -e . && cd -
cd gaussianformer/head/localagg_prob_fast && pip install -e . && cd -
